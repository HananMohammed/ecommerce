    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        <h5 class="card-title">{{trans('dashboards.individual')}}</h5>
                            ...
                            @if(count($data)>0)
                                <table id="example" class="display nowrap mb-0 table table-bordered table-striped" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th> {{trans('dashboards.details')}}</th>
                                    ...
                                    @foreach($data as $data)
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.dmails.show',[$data->id])}}" class="btn btn-primary">{{trans('dashboards.details')}}</a></td>

...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 m-t-5 ">
          <a href="{{route('admin.slider.create')}}">  <button type="button"  data-toggle="modal" data-target="#exampleModal" class="btn btn-primary btn-lg">{{trans('slider.addSlide')}} <i class="fas fa-plus"></i></button></a>
        </div>
        <br>
        <div class="col-md-12">
            <div class="card-body">
                        ...
                        <table id="example" class="display nowrap mb-0 table table-bordered table-striped" style="width:100%">
                            ...
                            @foreach($slides as $slide )
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.slider.edit',[$slide->id])}}" class="btn btn-primary">{{trans('tables.edit')}}</a></td>
                                    <td> <form method="post" action="{{route('admin.slider.destroy',[$slide->id])}}">@csrf @method('delete')<button type="submit" class="btn btn-danger">{{trans('tables.delete')}}</button></form></td>

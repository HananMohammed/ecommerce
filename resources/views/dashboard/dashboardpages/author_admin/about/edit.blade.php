                        ...
                        <div class="main-card p-5 card">
                            ...
                            @method('put')
                                <div class="form-group">
                                    ...
                                    <textarea type="text"    name="about_ar" id="aboutAr" class="form-control">{{$about->about_ar}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="aboutEn">{{trans('about.aboutEn')}}</label>
                                    <textarea type="text"    name="about_en" id="aboutEn" class="form-control">{{$about->about_en}}</textarea>
                                </div>
